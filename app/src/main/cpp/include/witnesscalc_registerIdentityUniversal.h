#ifndef WITNESSCALC_REGISTERIDENTITY2688_H
#define WITNESSCALC_REGISTERIDENTITY2688_H
...
int witnesscalc_registerIdentityUniversal(
...
#endif // WITNESSCALC_REGISTERIDENTITY2688_H
