#ifndef WITNESSCALC_registerIdentityUniversalRSA2048_H
#define WITNESSCALC_registerIdentityUniversalRSA2048_H
...
#define WITNESSCALC_ERROR_SHORT_BUFFER 0x2
    ...
    int
    witnesscalc_registerIdentityUniversalRSA2048(
