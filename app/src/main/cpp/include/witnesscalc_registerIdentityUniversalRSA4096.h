#ifndef WITNESSCALC_registerIdentityUniversalRSA4096_H
#define WITNESSCALC_registerIdentityUniversalRSA4096_H
...
#define WITNESSCALC_ERROR_SHORT_BUFFER 0x2
    ...
    int
    witnesscalc_registerIdentityUniversalRSA4096(
...
#endif // WITNESSCALC_QUERYIDENTITY_H
