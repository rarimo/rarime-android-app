#ifndef WITNESSCALC_FACEREGISTRYNOINCLUSION_H
#define WITNESSCALC_FACEREGISTRYNOINCLUSION_H
...
int
witnesscalc_faceRegistryNoInclusion(
...
#endif // WITNESSCALC_FACEREGISTRYNOINCLUSION_H
