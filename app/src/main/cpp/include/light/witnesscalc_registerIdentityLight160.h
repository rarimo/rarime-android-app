#ifndef WITNESSCALC_REGISTERIDENTITYLIGHT160_H
#define WITNESSCALC_REGISTERIDENTITYLIGHT160_H
...
int
witnesscalc_registerIdentityLight160(
...
#endif // WITNESSCALC_REGISTERIDENTITYLIGHT160_H
