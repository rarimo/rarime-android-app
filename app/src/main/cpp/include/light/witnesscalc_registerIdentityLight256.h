#ifndef WITNESSCALC_REGISTERIDENTITYLIGHT256_H
#define WITNESSCALC_REGISTERIDENTITYLIGHT256_H
...
int
witnesscalc_registerIdentityLight256(
...
#endif // WITNESSCALC_REGISTERIDENTITYLIGHT256_H
