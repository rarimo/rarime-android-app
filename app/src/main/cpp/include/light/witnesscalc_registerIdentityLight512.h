#ifndef WITNESSCALC_REGISTERIDENTITYLIGHT512_H
#define WITNESSCALC_REGISTERIDENTITYLIGHT512_H
...
int
witnesscalc_registerIdentityLight512(
...
#endif // WITNESSCALC_REGISTERIDENTITYLIGHT512_H
