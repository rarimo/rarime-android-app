#ifndef WITNESSCALC_REGISTERIDENTITYLIGHT384_H
#define WITNESSCALC_REGISTERIDENTITYLIGHT384_H
...
int
witnesscalc_registerIdentityLight384(
...
#endif // WITNESSCALC_REGISTERIDENTITYLIGHT384_H
