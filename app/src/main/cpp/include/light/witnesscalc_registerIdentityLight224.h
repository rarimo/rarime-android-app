#ifndef WITNESSCALC_REGISTERIDENTITYLIGHT224_H
#define WITNESSCALC_REGISTERIDENTITYLIGHT224_H
...
int
witnesscalc_registerIdentityLight224(
...
#endif // WITNESSCALC_REGISTERIDENTITYLIGHT224_H
