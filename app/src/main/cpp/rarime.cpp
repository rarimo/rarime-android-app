...
extern "C"
JNIEXPORT jint JNICALL
Java_com_distributedLab_rarime_util_ZkpUtil_registerIdentity2688(JNIEnv *env, jobject thiz,
    ...
    int result = witnesscalc_registerIdentity2688(
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_distributedLab_rarime_util_ZkpUtil_registerIdentity2704(JNIEnv *env, jobject thiz,
                                                                 jbyteArray circuit_buffer,
                                                                 jlong circuit_size,
                                                                 jbyteArray json_buffer,
                                                                 jlong json_size,
    ...
    int result = witnesscalc_registerIdentity2704(
            circuitBuffer, static_cast<unsigned long>(circuit_size),
            jsonBuffer, static_cast<unsigned long>(json_size),
            wtnsBuffer, &wtnsSize,
            errorMsg, static_cast<unsigned long>(error_msg_max_size));
